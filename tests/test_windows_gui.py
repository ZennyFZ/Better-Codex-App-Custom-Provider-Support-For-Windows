...
class WindowsGuiTests(unittest.TestCase):
    ...
    def test_gui_exposes_compact_classic_utility_spec(self):
        ...
        window_style = WS_CAPTION | WS_THICKFRAME | 0x00010000
        self.assertEqual(strip_caption_style(window_style), 0x00010000)
    ...
    def test_drag_position_does_not_recalculate_window_size(self):
        from patch_chatgpt_providers_windows_gui import format_drag_position

        self.assertEqual(format_drag_position(123, 456), "+123+456")
